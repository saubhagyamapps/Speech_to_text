...
public class SpeechService extends Service {
    ...
    private final StreamObserver<StreamingRecognizeResponse> mResponseObserver
        ...
        public void onNext(StreamingRecognizeResponse response) {
            ...
            Log.e(TAG, "Count---> " + response.getResults(0).getAlternativesList().get(0));
            Log.e(TAG, "String Value " + response.toString());
            if (response.getResultsCount() > 0) {
                final StreamingRecognitionResult result = response.getResults(0);
                Log.e(TAG, "Teitngggggggggggggggggggg" + result.getAlternatives(0).getTranscript());
                isFinal = result.getIsFinal();
                Log.e(TAG, "onNext:-----> " + isFinal);
